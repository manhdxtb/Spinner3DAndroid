...
public class TemplateView extends FrameLayout {
    ...
    private boolean size_min;

    private static final String FULL_TEMPLATE = "full_template";
...
//        }
    ...
    public String getTemplateTypeName() {
        ...
        } else if (templateType == R.layout.gnt_banner_template_view) {
            return BANNER_TEMPLATE;
        } else if (templateType == R.layout.gnt_full_template_view) {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        try {
            size_min = attributes.getBoolean(R.styleable.TemplateView_gnt_size_min, false);
        } catch (Exception e) {
        }
        try {
    ...
    public void onFinishInflate() {
        ...
        try {
            if (size_min) {
                findViewById(R.id.middle).setVisibility(TemplateView.GONE);
                findViewById(R.id.ad_notification_view_temp).setVisibility(TemplateView.VISIBLE);
            }
        } catch (Exception e) {
        }
...
//                    callToActionView.setScaleX(scale);
//                    callToActionView.setScaleY(scale);
//                }
//            });
//            animator.start();
        }
